  ...
  return (
    ...
    >
      ...
      <div className="relative z-40 flex flex-col items-center justify-center h-screen text-center px-4">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl bg-gradient-to-r from-[#75eefb] via-[#35a0a0] to-[#2e85ff] text-transparent bg-clip-text font-bold mb-8 animate-fade-in-up">
          An Innovative IT Solutions <br/> Agency
        </h1>

        {/* Subheading */}
        <p className="text-lg md:text-xl lg:text-2xl mb-8 max-w-2xl animate-fade-in-up">
          We provide cutting-edge IT solutions to help your business grow and thrive in the digital age.
        </p>
     ...
     <div>
      ...
      >
        <NavLink to="/services" className="hidden md:block absolute top-[55%] left-32">
            <button className="px-10 py-2 bg-[#010916] cursor-pointer border-2 font-semibold border-[#f9f9fb] rounded-3xl text-white xl:px-8 xl:text-lg">
             See Our Services
            </button>
          </NavLink>
      </div>
